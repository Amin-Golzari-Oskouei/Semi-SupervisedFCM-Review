...
for dataset in datasets:
    ...
    k, t_max, Restarts, fuzzy_degree, q, p_init, p_max, p_step, beta_memory, landa, labeled_rate, alpha, f, alpha2, Nr = parameters(dataset, lable_true, data, col)

    neighbors = find_neighbors(Nr, data)
    ...
    for repeat in range(Restarts):
        ...
        Cluster_elem = main(data, center_points, k, p_init, p_max, p_step, t_max, beta_memory, row, fuzzy_degree, col, q, landa, f, alpha, b, alpha2, neighbors, Nr)
        end_time = time.time()
