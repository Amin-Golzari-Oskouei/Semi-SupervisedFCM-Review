def main(data, center_points, k, t_max, row, fuzzy_degree, col, f, b, u_bar):
    import numpy as np
    import math
    import sys
...
#-----------------------------------------------------------------------------------------
    ...
    while 1:
        ...
        E_w = object_fun(row, col, k, Cluster_elem, center_points, fuzzy_degree, data, f, b, u_bar)
        ...
        mf = np.abs(Cluster_elem - u_bar) ** fuzzy_degree
        for j in range(k):
