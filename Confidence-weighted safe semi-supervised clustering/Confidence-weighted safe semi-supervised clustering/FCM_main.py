def FCM_main(data, center_points, k, t_max, row, fuzzy_degree, col):
    import numpy as np
    import math
    import sys
    from FCM_object_fun import FCM_object_fun
...
#-----------------------------------------------------------------------------------------
    ...
    while 1:
        ...
        E_w = FCM_object_fun(row, col, k, Cluster_elem, center_points, fuzzy_degree, data)
